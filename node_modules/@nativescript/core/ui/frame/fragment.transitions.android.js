...
function getTransitionListener(entry, transition) {
    ...
    TransitionListenerImpl.prototype.onTransitionStart = function (transition) {
        ...
        if (entry === null || entry === void 0 ? void 0 : entry.transition) {
            notifySharedTransition((_a = entry.transition) === null || _a === void 0 ? void 0 : _a.id, SharedTransition.startedEvent);
        }
    };
    TransitionListenerImpl.prototype.onTransitionEnd = function (transition) {
        ...
        if (entry === null || entry === void 0 ? void 0 : entry.transition) {
            notifySharedTransition((_a = entry.transition) === null || _a === void 0 ? void 0 : _a.id, SharedTransition.finishedEvent);
        }
    };
