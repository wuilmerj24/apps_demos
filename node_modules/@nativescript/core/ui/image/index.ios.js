...
export class Image extends ImageBase {
    ...
    createNativeView() {
        ...
        imageView.contentMode = 1 /* UIViewContentMode.ScaleAspectFit */;
    ...
    setTintColor(value) {
        if (this.nativeViewProtected) {
            if (value && this.nativeViewProtected.image && !this._templateImageWasCreated) {
                this.nativeViewProtected.image = this.nativeViewProtected.image.imageWithRenderingMode(2 /* UIImageRenderingMode.AlwaysTemplate */);
                ...
                this.nativeViewProtected.image = this.nativeViewProtected.image.imageWithRenderingMode(0 /* UIImageRenderingMode.Automatic */);
                queueGC();
            }
    ...
    [stretchProperty.setNative](value) {
        if (this.nativeViewProtected) {
            switch (value) {
                case 'aspectFit':
                    this.nativeViewProtected.contentMode = 1 /* UIViewContentMode.ScaleAspectFit */;
                    break;
                case 'aspectFill':
                    this.nativeViewProtected.contentMode = 2 /* UIViewContentMode.ScaleAspectFill */;
                    break;
                case 'fill':
                    this.nativeViewProtected.contentMode = 0 /* UIViewContentMode.ScaleToFill */;
                    break;
                case 'none':
                default:
                    this.nativeViewProtected.contentMode = 9 /* UIViewContentMode.TopLeft */;
                    break;
            }
        }
    }
