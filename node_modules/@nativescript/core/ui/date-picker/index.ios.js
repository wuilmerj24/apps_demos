...
export class DatePicker extends DatePickerBase {
    ...
    [dateProperty.setNative](value) {
        if (value) {
            const comps = NSCalendar.currentCalendar.componentsFromDate(4 /* NSCalendarUnit.CalendarUnitYear */ | 8 /* NSCalendarUnit.CalendarUnitMonth */ | 16 /* NSCalendarUnit.CalendarUnitDay */ | 32 /* NSCalendarUnit.HourCalendarUnit */ | 64 /* NSCalendarUnit.MinuteCalendarUnit */ | 128 /* NSCalendarUnit.SecondCalendarUnit */, this.nativeViewProtected.date);
    ...
    [maxDateProperty.setNative](value) {
        if (value) {
            ...
            this.nativeViewProtected.maximumDate = nsDate;
        }
        else {
    ...
    [minDateProperty.setNative](value) {
        if (value) {
            this.nativeViewProtected.minimumDate = NSDate.dateWithTimeIntervalSince1970(value.getTime() / 1000);
        }
        else {
